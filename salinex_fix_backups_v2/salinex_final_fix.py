...
==========================================
1. Remove Detect AI with Copyleaks watermark
...
def main():
    ...
    # [1/3] Remove Copyleaks
    print('\n[1/3] Removing Copyleaks watermark...')
    ...
    for py_file in py_files:
        ...
        try:
            with open(py_file, 'r', encoding='utf-8') as f:
                content = f.read()
            original = content
            content = content.replace('Detect AI with Copyleaks', '')
            content = content.replace('Copyleaks', '')
            content = content.replace('copyleaks', '')
            if content != original:
    ...
    print(f'  Done. Modified {copyleaks_removed} files.')
